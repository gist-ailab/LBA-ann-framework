...
class NestedTensorBlock(Block):
    def forward_nested(self, x_list: List[Tensor], return_attention=False, return_qkv=False) -> List[Tensor]:
        """
    ...
    def forward(self, x_or_x_list, return_attention=False, return_qkv=False):
        ...
        if isinstance(x_or_x_list, Tensor):
            ...
            return self.forward_nested(x_or_x_list, return_attention, return_qkv)
        else:
